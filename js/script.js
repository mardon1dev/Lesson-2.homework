...
const allPeople = document.querySelector('.row');
const allDatas = users.map((person) => {
    return `
    <div class="col-md-4 person">
        <div class="card" style="width: 100%;">
            <img src=${person.avatar_url} class="card-img-top" alt=${person.login}>
            <div class="card-body">
                <h5 class="card-title">${person.login}</h5>
                <p class="card-text">${person.type}</p>
...
allPeople.innerHTML = allDatas.join('');
...
//         if(all[i].textContent.toLowerCase().includes(search_query.toLowerCase())) {
//             all[i].classList.remove("yes");
//         } else{
//             all[i].classList.add("yes");
//         }
//     }
// }
// let typingTimer;               
